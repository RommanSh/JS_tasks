...
class Options {
    constructor(height, width, bg, fontSize, textAligh) {
        this.height = height;
        this.width = width;
        this.bg = bg;
    ...
    createDiv() {
        ...
        let param = `height:${this.height}px; width:${this.width}px; background-color:${this.bg}; font-size:${this.fontSize}; text-aline:${this.textAligh}`;
